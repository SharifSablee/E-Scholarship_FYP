  ...
  <body>
    ...
    <header>
      <div class="container-fluid">
        ...
        >
          <!-- logo -->
          <a href="index.php" class="navbar-brand col-lg-7"
          ...
          <div class="collapse navbar-collapse col-lg-5" id="navbarToggler">
            <!-- nav menu -->
            <ul class="navbar-nav">
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="agency-profile.php" class="nav-link">Profile</a>
              </li>
              <li class="nav-item">
                <a href="agency-programme.php" class="nav-link">Programmes</a>
              </li>
              <li class="nav-item">
